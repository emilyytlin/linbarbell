(function(global) {
  ...
  var WilksViewModel = function() {
    ...
    this.m = { 'a': -216.0475144, 'b': 16.2606339, 'c': -0.002388645, 'd': -0.00113732, 'e': 7.01863E-06, 'f': -1.291E-08};
    this.f = {'a': 594.31747775582, 'b': -27.23842536447, 'c': 0.82112226871, 'd': -0.00930733913, 'e': 4.731582E-05, 'f': -9.054E-08 };
    this.results = ko.observableArray();
    this.showInfo = ko.observable(false);
    this.displayCoeff = function(c) { return 'a = ' + c.a + '\nb = ' + c.b + '\nc = ' + c.c + '\nd = ' + c.d + '\ne = ' + c.e + '\nf = ' + c.f; };
  };
  ...
  WilksViewModel.prototype.calculate = function() {
    ...
    var c = this.wilks.sex() === 'F' ? this.f : this.m;
